...
<?php if (isset($driver_data)) {
 foreach ($driver_data as $key => $value) {?>
	...
	<br/>
	<p><a href="<?php echo (is_null($value['Datasheet_file']) ? ' ' : base_url().'assets/App_files/Datasheet/Driver/'.$value['Datasheet_file']).'" download="driver_datasheet_'.$value['Code']?>">download datasheet of this driver</a></p>
