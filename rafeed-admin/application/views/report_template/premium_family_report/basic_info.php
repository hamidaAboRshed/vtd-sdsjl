...
<div style="text-align: center;">
	<img src="<?php echo $this->navigation->get_includes_url().'/upload_files/Product/Premium/'.$Product_id.'/'.$family_photo;?>" width="100%" >
</div>
<!-- <div>
...
<div style="text-align: center;">
	<img src="<?php echo $this->navigation->get_includes_url().'/upload_files/Product/Premium/'.$Product_id.'/'.$application_photo;?>" width="100%">
</div>
<?php }?>
