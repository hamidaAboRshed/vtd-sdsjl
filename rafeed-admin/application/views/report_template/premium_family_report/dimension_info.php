...
<table>
  ...
  <?php if (is_array($value['product_photo'])){
          foreach ($value['product_photo'] as $key_multi => $value_multi) {?>
             <tr>
              <td>
                <img src="<?php echo $this->navigation->get_includes_url().'/upload_files/Product/Premium/'.$value['product_id'].'/'.$value_multi['FileName'];?>" width="50%">
              </td>
              <td>
                 <img src="<?php echo $this->navigation->get_includes_url().'/upload_files/Product/Premium/'.$value['product_id'].'/'.$value['Dim_photo'][$key_multi]['FileName'];?>" width="50%">
              </td>
            </tr>
           <?php }
       }
  ...
  <tr>
    <td>
      <img src="<?php echo $this->navigation->get_includes_url().'/upload_files/Product/Premium/'.$value['product_id'].'/'.$value['product_photo'];?>" width="50%">
    </td>
    <td>
      <img src="<?php echo $this->navigation->get_includes_url().'/upload_files/Product/Premium/'.$value['product_id'].'/'.$value['Dim_photo'];?>" width="50%">
    </td>
  </tr>
<?php }?>
  <?php } ?>
