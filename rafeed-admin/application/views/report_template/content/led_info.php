...
<?php if(isset($led_data)){
 foreach ($led_data as $key => $value) {?>
	...
	<br/>
	<p><a href="<?php echo (is_null($value['Datasheet_file']) ? ' ' : base_url().'assets/App_files/Datasheet/Led/'.$value['Datasheet_file']).'" download="led_datasheet_'.$value['Code']?>">download datasheet of this LED</a></p>
