        ...
        ?>
         <div class="col-md-2 col-sm-3">
            ...
            <p class="mbr-text mbr-links-column mbr-fonts-style display-7 footer-link">
                ...
                <br><a href="<?php echo $this->navigation->get_base_url()?>/Home/about" class="text-black footer-link">About</a>
                <br><a href="<?php echo $this->navigation->get_base_url()?>/Home/agents" class="text-black footer-link">Agents</a>
                <!-- <br><a href="/Home/cct_info" class="text-black footer-link">Knowledge</a> -->
				<br><a href="<?php echo $this->navigation->get_base_url()?>/Home/contact_us" class="text-black footer-link">Contact us</a>
            ...
            <p class="mbr-text mbr-links-column mbr-fonts-style display-7 footer-link">
                <a href="<?php echo $this->navigation->get_base_url()?>/article" class="text-black footer-link">Articles</a>
            </p>
            </div>
        </div>
