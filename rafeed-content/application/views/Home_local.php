...
<!-- <script type="text/javascript">
     window.onload = function() {
    var img = document.querySelector("#premium_img");
    document.body.classList.add('js-loading');
    img.addEventListener("load", removeLoadingClass);
    }
    function removeLoadingClass() {debugger;
    ...
    <div class="container align-center">
        <div class="premium_header">
            ...
            <div class=""  id="premium_link">
                <a href="<?php echo base_url();?>index.php/Catalog/premium" >Open Catalogue ></a>
            </div>
            <div class=""  id="premium_link">
                <a href="<?php echo base_url();?>index.php/Product/Product_series_list/1" >Read More ></a>
            </div>
        </div>
        <!-- <figure>
        ...
        <div class="row justify-content-md-center" style="margin: 0;">
            ...
            <image overflow="visible" width="2500" height="1309" id="premium_img" xlink:href="http://www.atclighting.co/assets/images/home-product/products-premium1.png" transform="matrix(0.377 0 0 0.377 0 0)"></image>
            ...
            <div id="led-screen-container" class="right-content ml-auto" style="height: -webkit-fill-available;background-image:url('<?php echo base_url();?>/assets/images/home-product/led-screen-section-bg.png');background-size: cover;">
                <div id ="led-screen-content">
                    ...
                    <div class="ml-auto" style="text-align: center;">
                        ...
                        <div class="section-p row center"  id="premium_link">
                            <div  class="col" style="padding: 20px 0;text-align: center;">
                                <a href="<?php echo base_url();?>index.php/Product/Product_series_list/5" >< Read More </a>
                            </div>
                        </div>
                    </div>
                </div>
