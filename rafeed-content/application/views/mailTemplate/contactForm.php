            ...
            <tr>
                <td valign="top" style="display:block;clear:both;margin:0 auto;max-width:580px;">
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse;">
                        <tr>
                            <td valign="top" align="center" class="masthead" style="padding:10px 0;background: #333;color:white;">
                                <h1 style="font-size:32px;margin:0 auto;max-width:90%;line-height:1.25;color:#fff;">
                                    <a href="<?php print site_url(); ?>" target="_blank" style="text-decoration:none;color:#ffffff;">
									 <img src="<?php echo base_url();?>/assets/images/logo/rafeed/rafeed-logo.png" alt="Rafeed" height="30" width="200" style="color: #fff; font-size: 18px; display: block;">
									 </a>
